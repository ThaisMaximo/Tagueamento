...
Imagem com descrição: <img src="img_girl.jpg" alt="Girl with a jacket" width="500" height="600">
Imagem com link nela: <a href="colocarolink" target="_blank">
Botões: <button>Click me</button>
Design da fonte: <p style="color:red">I am a paragraph</p>
Tooltip: <p title="I'm a tooltip">
This is a paragraph.
</p>
Listas: <ul>
  <li>Coffee</li>
